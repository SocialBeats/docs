...
- **Derecho a la Información:** Conocer cómo se procesan sus datos y para qué fines.  
- **Derecho de Acceso:** Solicitar acceso a los datos personales que SocialBeats posee sobre ellos.  
- **Derecho a la Rectificación:** Corregir datos personales incorrectos o incompletos.  
- **Derecho a la Supresión ("Derecho al Olvido"):** Solicitar la eliminación de sus datos bajo condiciones específicas.  
- **Derecho a la Limitación del Tratamiento:** Limitar el uso de sus datos en ciertas circunstancias.  
...
### **Pasarelas de Pago**
Se comparten datos como detalles de facturación, información de tarjetas de crédito y registros de transacciones, únicamente para procesar pagos de forma segura.
...
Aplicando medidas de seguridad avanzadas para prevenir accesos no autorizados, brechas de seguridad o pérdidas de datos.
