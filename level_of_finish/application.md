...
- Debe estar desplegado y ser accesible desde la nube (ya sea de forma individual o como parte de la
  ...
  - El frontend está accesible en [https://socialbeats.es/socialbeats/](https://socialbeats.es/socialbeats/) y la API en [https://api.socialbeats.es/socialbeats-api/health](https://api.socialbeats.es/socialbeats-api/health). Se ha usado _Digital Ocean_ como proveedor Cloud, donde tenemos un cluster de Kubernetes, y se ha usado IONOS para el DNS. La documentación de la API esta disponible en [https://api.socialbeats.es/socialbeats-api/api-docs/](https://api.socialbeats.es/socialbeats-api/api-docs/)
